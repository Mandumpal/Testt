...
<section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Land Detail Registration</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Land Registration</h4>
              <form class="form-horizontal style-form" method="post">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="User_name">
                  </div>
                </div>
                <div class="form-group">
                ...
                <input type="submit" class="btn btn-theme" value="landform" name="submit">
