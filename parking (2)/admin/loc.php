             ...
             $where_condition = array(  
                  ...
                  // All key names are collumn name of db table collumns.
                    $update_data = array(  
                       ...
                       'pincode'  =>   mysqli_real_escape_string($data_obj->con, $_POST['pincode'])
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="Capacity">
                  </div>
                </div>
                <div class="form-group" >
                  <label class="col-sm-2 col-sm-2 control-label">plot no</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="plot_no">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Total area</label>
                  <div class="col-sm-10">
                    <input class="form-control"  name="Total_area" type="text">
                  </div>
                </div>
				<div class="form-group">
