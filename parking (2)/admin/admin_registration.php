...
if(isset($_POST['submit'])){
      ...
      if(isset($_POST['edit'])){
             ...
             $where_condition = array(  
                  ...
                  // All key names are collumn name of db table collumns.
                    $update_data = array(  
                       ...
                       'a_id'  =>    mysqli_real_escape_string($data_obj->con, $_POST['Location_ID']),
                       'name'  =>     mysqli_real_escape_string($data_obj->con, $_POST['Name']),
                       'username' =>   mysqli_real_escape_string($data_obj->con, $_POST['UserName']),
              ...
              if($data_obj->update("admin_registration", $update_data, $where_condition))  
              {  
           ...
           if($data_obj->insert("admin_registration",$insert_data))
          {
 ...
 if(isset($_GET['edit'])){  // display input box values
        ...
        $post=$data_obj->select_where("admin_registration",$where);
    ...
    if(isset($_GET["delete"]))  
        {  
          ...
          if($data_obj->del("admin_registration", $where))  
          {  
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Admin Manager Registration</h4>
