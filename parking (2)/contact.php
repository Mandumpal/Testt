...
<?php include('header.php'); ?>
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="sevice.php">Service</a></li>
			...
			<div class="row contact_content">
				<div class="col-lg-5">
					<div class="contact_text">
						<p>The people to park their vehicles in a authorised parking area by providing them the details and location of near by areas.Anybody can enter into this website with their name,vehicle number and their current location.By recieving the location,we provide the nearest parking areas around them.The website with the aim of helping the people to know about parking space in an unknown space especially in kerala.The owners of parking areas to register with the website and handle thier area effectively and efficiently.</p>
					</div>
