...
<meta name="description" content="Parking management">
...
<?php include('header.php'); ?>
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="Service.php">Service</a></li>
						...
						<!-- Search -->
						<div class="search">
							<form action="index.php" class="search_form">
	...
	<div class="home">
		<div class="home_background" style="background-image:url(images/home2.jpg)"></div>
		<div class="home_background" style="background-size: 10"></div>
		<div class="home_content">
			<div class="home_content_inner">
				<div class="home_text_large">Parking</div>
				<div class="home_text_small">WAY TO PARKING</div>
			</div>
		</div>
	</div>
	...
	<div class="find">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="find_title text-center">Find the locations for Parking</div>
				</div>
				<div class="col-12">
					<div class="find_form_container">
						<form action="#" id="find_form" class="find_form d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-between justify-content-start flex-wrap">
							...
							<!-- <div class="find_item">
								...
								<select name="vehicle" id="vehicle" class="dropdown_item_select find_input">
							...
							<button style="margin-right:35%;"  class="button find_button">Find</button>
						</form>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h2>Top parking areas</h2>
						<div>take a look at these Service</div>
					</div>
				</div>
			</div>
			<div class="row top_content">
				...
				<div class="col-lg-3 col-md-6 top_col">
					...
					<div class="top_item">
						<a href="#">
							<div class="top_item_image"><img src="images/paru.jpg" alt="https://unsplash.com/@sgabriel"></div>
							<div class="top_item_content">
								<div class="top_item_price">RS.50</div>
