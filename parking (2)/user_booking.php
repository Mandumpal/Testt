...
if(isset($_POST["add"]))
{
	...
	//echo $user;
	$insert_data = array(
                         'Booking_No'  =>    mysqli_real_escape_string($data->con, $_POST['Booking_No']),
                       'Current_Location'  =>     mysqli_real_escape_string($data->con, $_POST['Current_Location']),
                       'Booked_Location'  =>     mysqli_real_escape_string($data->con, $_POST['Booked_Location']),
                       'vehicle'  =>   mysqli_real_escape_string($data->con, $_POST['vehicle']),
                       'vehicle_No'  =>   mysqli_real_escape_string($data->con, $_POST['vehicle_No'])
                   
                  );


           if($data->insert("booking",$insert_data))
          {

            $success_message='Booking Successfully completed, Booking valid upto 3Hours';
          }	// if($user=="owner")
	// {
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Booking_No" pattern="[0-9]+" title="Numeric numbers only allowed" id="name"placeholder="Booking No">                   
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" name="Current_Location" id="u_email" type="text" placeholder="Current Location" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control"id="password" name="Booked_Location" placeholder="Booked Location">
                  </div>
                </div>
                <div class="form-group">
                  <!-- <label class="col-sm-2 col-sm-2 control-label">Password</label> -->
                  <div class="col-sm-10">
                    <input type="text" class="form-control"id="password" name="vehicle" placeholder="Vehicle Type" required>
                  </div>
                </div>
                <div class="form-group">
                  <!-- <label class="col-sm-2 col-sm-2 control-label">Password</label> -->
                  <div class="col-sm-10">
                    <input type="text" class="form-control"id="password" name="vehicle_No" placeholder="Vehicle No" required>
                  </div>
                </div>
                 <input type="submit" class="btn btn-theme" name="add" value="BookNow">
