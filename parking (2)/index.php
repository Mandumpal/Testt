			...
			<div class="menu menu_mm">
				<div class="menu_search_form_container">
					<form action="#" id="menu_search_form">
						...
						<button id="menu_search_submit" class="menu_search_submit" ><img src="images/search_2.png" alt=""></button>
					</form>
				</div>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="find_form_container">
						<form action="#" id="find_form" method="post" class="find_form d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-between justify-content-start flex-wrap">
							
							
							<div style="margin-left: 25%;" class="find_item">
								<div>Search:<img src="images/search.png" alt=""></div>
								<input type="text" id="myInput" name="find" required="required" placeholder="Keyword here">
								
								<button  class="menu_search_submit"  name="submit" id="submit"type="submit" ><img src="images/search_2.png" alt=""></button>
							...
							<!-- <button style="margin-right: 25%;" class="button find_button">Find</button> -->
 ...
 <?php
 							...
 							if(isset($_POST["submit"]))
							{
								$q=$_POST["find"];
								 ...
								 $sql="select * from location where District LIKE '%$q%' or `City` LIKE '%$q%' ";
								$result=mysqli_query($con,$sql);
								while($sql1=mysqli_fetch_array($result, MYSQLI_NUM))
								{
									//print_r($sql1);
									$pin=$sql1[6];
									  $sql="SELECT * FROM `location` where pincode ='$pin'";
												
										$result=mysqli_query($con,$sql);
										
										if($result->num_rows >0)
										{
											while($sql1=$result->fetch_array()){
												?>
												<td><?php echo $sql1[1];?></td>
			
													<td><?php echo $sql1[0];?></td>

													<td><?php echo $sql1[2];?></td>
																<td><?php echo $sql1[3];?></td>
																<td><?php echo $sql1[4];?></td>
																<td><?php echo $sql1[5];?></td>

													<td><a href="user_booking.php" ><button class="btn btn-success">book now</button></a></td>
																<!-- <td>
						...
						<a href="#">
							...
							<div class="top_item_content">
								...
								<div class="top_item_text">Paris, France</div>
										...
										<div ><button class="button" type="submit" style=" background-color:green;"><span style="color: white">BOOKNOW</span></button></div>
					</div>
				</div>
